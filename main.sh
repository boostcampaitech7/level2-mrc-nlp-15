...
train_dir="models/train_CircleTest"
python src/main.py --output_dir $train_dir --do_train --max_seq_length 384 --per_device_train_batch_size 16 --num_train_epochs 3 --learning_rate "1e-5" --b_is_circle "True"
